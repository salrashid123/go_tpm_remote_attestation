...
type PullRSAKeyResponse struct {
	...
	Uid          string `protobuf:"bytes,1,opt,name=uid,proto3" json:"uid,omitempty"`
	RsaPublicKey []byte `protobuf:"bytes,2,opt,name=rsaPublicKey,proto3" json:"rsaPublicKey,omitempty"`
	Signature    []byte `protobuf:"bytes,3,opt,name=signature,proto3" json:"signature,omitempty"`
	Attestation  []byte `protobuf:"bytes,4,opt,name=attestation,proto3" json:"attestation,omitempty"`
}
...
func (x *PullRSAKeyResponse) GetRsaPublicKey() []byte {
	if x != nil {
...
func (x *PullRSAKeyResponse) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
var file_verifier_verifier_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x70, 0x63, 0x72, 0x22, 0x8a, 0x01, 0x0a, 0x12, 0x50, 0x75,
	0x6c, 0x6c, 0x52, 0x53, 0x41, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75,
	0x69, 0x64, 0x12, 0x22, 0x0a, 0x0c, 0x72, 0x73, 0x61, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b,
	0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x72, 0x73, 0x61, 0x50, 0x75, 0x62,
	...
	0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x61, 0x74, 0x74, 0x65, 0x73,
